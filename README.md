...
<img width="700" alt="로그인 화면" src="이미지URL" /><br/>
<sub>로그인 화면</sub>

<img width="700" alt="학생 회원가입" src="이미지URL" /><br/>
...
<img width="700" alt="코드로 강의실 참여" src="이미지URL" /><br/>
...
<table>
  <tr>
    <td align="center">
      <img width="480" alt="학생 대시보드" src="이미지URL" /><br/>
      <sub><b>학생</b> — 내가 입장한 강의실 목록</sub>
    </td>
    <td align="center">
      <img width="480" alt="교수 대시보드" src="이미지URL" /><br/>
...
<img width="500" alt="새 강의실 개설" src="이미지URL" /><br/>
...
<img width="700" alt="강의자료 목록" src="이미지URL" /><br/>
<sub>강의자료 목록 및 다운로드</sub>

<img width="500" alt="강의자료 등록" src="이미지URL" /><br/>
...
<img width="700" alt="Q&A 화면" src="이미지URL" /><br/>
...
<img width="700" alt="공지사항" src="이미지URL" /><br/>
<sub>공지사항 목록</sub>
